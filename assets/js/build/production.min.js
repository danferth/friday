...
var find_time = function(sec, count){
  ...
  $('.countdown .day').html(diff_days + "<span>Days</span>");
  $('.countdown .hour').html(diff_hours + "<span>Hours</span>");
  $('.countdown .minute').html(diff_minutes + "<span>Minutes</span>");
  $('.countdown .second').html(diff_seconds + "<span>Seconds</span>");
